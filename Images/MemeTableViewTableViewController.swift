//
//  MemeTableViewTableViewController.swift
//  Images
//
...
class MemeTableViewTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "tables", for: [(indexPath as NSIndexPath).row])
        let memespopulate = self.memes[(indexPath as NSIndexPath).row]
        cell.textLabel?.text = "\(memespopulate.topText)...\(memespopulate.bottomText)" // this has to contain the memed image's text
        cell.imageView?.image = memespopulate.memedImage // add the image memed
        return cell
